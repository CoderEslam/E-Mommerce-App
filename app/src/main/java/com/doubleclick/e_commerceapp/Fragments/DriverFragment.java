...
import com.doubleclick.e_commerceapp.DeliveryDrivers.SettingDriverActivity;
...
public class DriverFragment extends Fragment implements OnMapReadyCallback, RoutingListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        try {
            SupportMapFragment mapFragment = (SupportMapFragment) getActivity().getSupportFragmentManager().findFragmentById(R.id.Drivermap);
...
/* mHistory.setOnClickListener(new View.OnClickListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if(dataSnapshot.exists() && dataSnapshot.getChildrenCount()>0){
                    ...
                    if(map.get("profileImageUrl")!=null){
                        Glide.with(getContext()).load(map.get("profileImageUrl").toString()).into(mCustomerProfileImage);
                    }
                }
            }
                    ...
                    switch (customerId){
                        case "":
                            geoFireWorking.removeLocation(userId, new GeoFire.CompletionListener() {
                                @Override
                                public void onComplete(String key, DatabaseError error) {
                                    Toast.makeText(getContext(),"customerId At 436"+customerId,Toast.LENGTH_LONG).show();
                                }
                            });
                            geoFireAvailable.setLocation(userId, new GeoLocation(location.getLatitude(), location.getLongitude()), new GeoFire.CompletionListener() {
                                @Override
                                public void onComplete(String key, DatabaseError error) {
                                    Toast.makeText(getContext(),"Key At 442"+key,Toast.LENGTH_LONG).show();
                        ...
                        default:
                            geoFireAvailable.removeLocation(userId, new GeoFire.CompletionListener() {
                                @Override
                                public void onComplete(String key, DatabaseError error) {
                                    Toast.makeText(getContext(),"Key At 452"+key,Toast.LENGTH_LONG).show();
                                }
                            });
                            geoFireWorking.setLocation(userId, new GeoLocation(location.getLatitude(), location.getLongitude()), new GeoFire.CompletionListener() {
                                @Override
                                public void onComplete(String key, DatabaseError error) {
                                    Toast.makeText(getContext(),"Key At 458"+key,Toast.LENGTH_LONG).show();
    ...
    private void disconnectDriver(){
        ...
        geoFire.removeLocation(userId, new GeoFire.CompletionListener() {
            @Override
            public void onComplete(String key, DatabaseError error) {
                Toast.makeText(getContext(),"disconnectDriver = "+"Key At 524"+key,Toast.LENGTH_LONG).show();
            }
        });
    }
